"""This file contains the tests for my-chart-verifier. It follows behavioral driven development using pytest-bdd.
...
- KUBECONFIG: Path to the kubeconfig file to use to connect to the OCP cluster to deploy the charts on.
"""
...
def run_verifier(image_type, profile_type, target_location, command, pgp_key_location=None):
    """Run my-chart-verifier command and capture output

    Args:
        image_type (str): How to run my-chart-verifier. Options: tarball, podman.
        ...
        pgp_key_location (str, optional): Path to the GPG public key of the key used to sign the chart.
...
def check_report(verify_result, profile_type, report_info_location, image_type, verifier_version):
    """Compares the output of my-chart-verifier against a pre-generated report, containing the expected results.

    Fails the tests if a difference is found.

    Args:
        verify_result (str): Output of my-chart-verifier command.
        profile_type (str): Profile to use. Options: partner, redhat, community.
        report_info_location (str): Path to the pre-generated report.
        image_type (str): How to run my-chart-verifier. Options: tarball, podman.
        verifier_version (str): Normalized version as given by my-chart-verifier.
    """
